...
--[[ 
    ...
    scriptblox: https://scriptblox.com/script/Universal-Script-XREXZOB-I-Emote-Script-48024
]]
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/XREXZOB/xrexzob-hub/main/menu.lua"))()
...
local function GetAsset(asset)
    ...
    if assetStr:find("http") then
        ...
        local path = "XREXZOB/Assets/" .. filename
        ...
        if isfile(path) then
            ...
            if not isfolder("XREXZOB/Assets") then 
                pcall(function()
                    if not isfolder("XREXZOB") then makefolder("XREXZOB") end
                    makefolder("XREXZOB/Assets") 
                end)
            end
            ...
            if success and content and content ~= "" then
                ...
                if low:find("<!doctype") or low:find("<html") or low:find("<head") then
                    warn("XREXZOB | GetAsset: Downloaded content appears to be HTML. Link might be incorrect: " .. targetUrl)
                    return ""
                end
...
local function onCharacterAdded(character)
 ...
 if getgenv().autoReloadEnabled and getgenv().lastPlayedAnimation then
    ...
    getgenv().Notify({
        Title = 'XREXZOB | Auto Reload Animation',
